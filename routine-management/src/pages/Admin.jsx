    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                ...
                setToast({ message: 'রুটিন আপডেট হয়েছে', type: 'success' });
            } else {
            ...
            setToast({ message: editingId ? 'রুটিন আপডেটে সমস্যা হয়েছে' : 'রুটিন যোগে সমস্যা হয়েছে', type: 'error' });
        } finally {
            setLoading(false);
            setTimeout(() => setToast({ message: '', type: '' }), 3000);
        }
                            ...
                            {routines.map((r) => (
                                <li key={r.id} className="flex justify-between items-start py-4">
                                    ...
                                    <button
                                        ...
                                        className="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-1 rounded-md transition mr-2"
                                    >
                                        সম্পাদনা
                                    </button>
                                    <button
